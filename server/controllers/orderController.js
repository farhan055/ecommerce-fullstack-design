...
const getEmailTemplate = (order, isAdmin = false) => {
    ...
    <div style="background-color: #f4f4f4; padding: 20px; font-family: 'Times New Roman', Times, serif;">
        <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px; background-color: #ffffff; border: 1px solid #e0e0e0; box-shadow: 0 4px 10px rgba(0,0,0,0.1);">
            <tr>
